...
namespace Travel.Shared.Ultilities
{
    ...
    public static class Ultility
    {
        ...
        public static string getHtmlBookingSuccess(string pincode,string fullname, string phone, string totalamount, string qr, string statuspayment)
        {
            try
            {
                string body = $@"<!DOCTYPE html PUBLIC ' -//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><link href='https://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' /></head><body style=' font-family: 'Roboto', sans-serif;font-size: 14px;min-width: 760px;'><table cellpadding='0' cellspacing='0' width='760' border='0' style='padding: 1rem;  border-radius: 10px;border: 1px solid #505050;margin:auto;background: linear-gradient(-180deg, #1ae28a, #209077 150%)'><tr><td colspan='2'><table width='100%'><tr><td><a href='https://travel.com.vn/Content/Theme/images/logo.png' target='_blank'><img src='https://res.cloudinary.com/ddv2idi9d/image/upload/v1671287460/Uploads/Logoaiu_xkmijd.png'width='208px' height='70px' alt='logo' /></a></td><td align='right'><div style='margin-left: 260px; text-align: left'><a href='tel:19001839'><span style='color: #c50000; font-weight: bold; font-size: 20px;'>1900 1839</span></a><br /><span style='color: #333; font-size: 11px;'>cước gọi 1000đ/phút</span></div></td></tr></table></td></tr><tr><td colspan='2'><div style='text-align: center; font-weight: bold; text-transform: uppercase; color: #000; font-size: 24px; padding-top: 20px; padding-bottom: 20px; border-bottom: 1px dotted #ccc; border-top: 1px dotted #ccc; margin-bottom: 30px;'>BOOKING THANH TOÁN</div></td></tr><tr><td colspan='2'><div style='font-weight: bold; text-transform: uppercase; color: #c50000; margin-bottom: 10px; font-size: 16px'>A. THÔNG TIN BOOKING:</div><div class='col' style='width: 25% ; min-height: 130px; padding: 16px;float: left ;overflow:auto'><img src='{qr}' width='70%' ></div><table width='50%' style='margin-top: 2rem; font-size: 15px;'><tr></tr><tr><td style='font-weight:bold'> Pincode:</td><td colspan='3'><a href='' target='_blank' style=' font-style: italic;'>{pincode}</a></td></tr><tr><td style='font-weight:bold'>Họ tên:</td><td>{fullname}</td></tr><tr><td style='font-weight:bold'>Số điện thoại:</td><td>{phone}</td></tr><tr><td style='font-weight:bold'>Tình trạng thanh toán:</td><td>{statuspayment}</td></tr><tr><td style='font-weight:bold'>Tổng tiền thanh toán:</td><td>{totalamount}</td></tr><tr></tr></table></td></tr>   <tr><td colspan='2'>Vui lòng liên hệ với tổng đài để thông báo tình trạng và hoàn tiền cho khách.<hr></td></tr><tr><td colspan='2'>&nbsp;</td></tr><tr><td colspan='2' style='font-weight:bold;font-style: italic;text-align:center;color: #c50000'><div style='margin-bottom: 15px;'>Đây là email tự động Quý khách vui lòng không phản hồi vào email này</div></td></tr><tr><td colspan='2' style='height: 30px; text-align: center; padding-top: 15px; padding-bottom: 15px; color: #fff;'><div style='margin-bottom: 5px;'> 100 To Ty, District 12, Ho Chi Minh City, Viet Nam</div><div><span>Điện thoại:</span> (+84 29) 8248 4908- <span>Fax:</span> (+84 29) 98248 4908 - <span>Email:</span> <a href='mailto:info@travelRover.com'>info@travelRover.com</a></div></td></tr></table></body></html>";
        ...
        public static string getHtmlBookingTicket(string pincode, string fullname, string idtour, string qr , string departuredate , string returndate)
        {
            try
            {
                string body = $@"<!DOCTYPE html PUBLIC ' -//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><link href='https://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' /></head><body style=' font-family: 'Roboto', sans-serif;font-size: 14px;max-width: 450px;'><table cellpadding='0' cellspacing='0' width='450' border='0' style='border-radius: 20px 20px 10px 10px;border: 1px solid #505050;margin:auto;background-color: whitesmoke;'><tr><td colspan='2' style='background: linear-gradient(-180deg, #1ae28a, #209077 150%) ; border-radius: 20px 20px 0 0;'><table width='100%'><tr><tr> <div class='header-content'><div style=' text-transform: uppercase;margin-top: 0.5rem;;color: whitesmoke; font-size: 24px;text-align: center;font-weight: 800;'>Vé Du Lịch</div> </div></tr><td><a href='https://travel.com.vn/Content/Theme/images/logo.png' target='_blank'><img src='https://res.cloudinary.com/ddv2idi9d/image/upload/v1671287460/Uploads/Logoaiu_xkmijd.png'width='208px' height='70px' alt='logo' /></a></td><td align='right'><div class='col-right' style='margin-right: 0.5rem;'><img src='{qr}' style='width: 80px;'  alt=''></div></td></table></td></tr><tr></tr><tr><td colspan='2' style='padding: 0.5rem;'><div style='font-weight: bold; text-transform: uppercase; color: #c50000; margin-bottom: 10px; font-size: 16px ; margin-top: 1rem;'>THÔNG TIN BOOKING:</div><table width='100%' style='font-size: 20px; max-width: 90%;border-bottom: 1px black; '><tr><td style='font-weight:bold'>Số booking:</td><td ><a href='' style='color: black;'>{pincode}</a></td></tr><tr><td style='font-weight:bold'>Mã Tour:</td><td>{idtour}</td></tr><tr><td style='font-weight:bold'>Họ tên:</td><td>{fullname}</td></tr><tr></table></td></tr>   <tr><td>  <div class='row' style='margin-left: 1rem;position: relative;'><div class='col-3'><h2>{departuredate}</h2></div><div class='col-3' style=' padding: 4rem;margin-top: -7rem; '><img width='150px' src='https://res.cloudinary.com/ddv2idi9d/image/upload/v1671805446/pngtree-bus-transport-illustration-image_1407203-removebg-preview_fluxrf.png' alt=''></div><div class='col-3' style='position: relative;margin-top: -9rem;margin-left: 18rem;'><h2>{returndate}</h2></div><hr></td>  </tr><tr><td colspan='2'>&nbsp;</td></tr><tr><td colspan='2' style='font-weight:bold;font-style: italic;text-align:center;color: #c50000'><div style='margin-bottom: 15px;'>Đây là email tự động Quý khách vui lòng không phản hồi vào email này</div></td></tr><tr><td colspan='2' style='height: 30px;'> <div  style='font-size: 15px;font-style: italic;line-height: 1.25;padding: 15px 25px;'>Cảm ơn các bạn đã sử dụng Travel Rover <br>Emai : info@travelRover.com<div class='ky' style='margin-left: 14rem;margin-top: -2rem;width: 113px;'><img src='https://res.cloudinary.com/ddv2idi9d/image/upload/v1671720076/Uploads/signature-removebg-preview_vkicjq.png' width='200px' alt=''></div></div></td></tr></table></body></html>";

                body = body.Replace("{pincode}", pincode);
                body = body.Replace("{fullname}", fullname);
                body = body.Replace("{idtour}", idtour);
                body = body.Replace("{departuredate}", departuredate);
                body = body.Replace("{returndate}", returndate);
                body = body.Replace("{qr}", qr);
                return (body);
